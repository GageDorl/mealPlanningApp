...
A cross-platform meal planning app built with Expo and React Native.
...
> **Status:** Early development — project scaffolding and web support are in place. Feature planning is next.
...
| Folder | Purpose |
|--------|---------|
| `mealPlan/` | Expo app — source code, config, and assets |

See [`mealPlan/README.md`](./mealPlan/README.md) for full documentation.
